...
public abstract class LectorConfiguracion {
	...
	private static String buscarConfiguracion(String configuracion) throws IOException {
		...
		throw new IOException("No se pudo encontrar el archivo configuracion.txt en la carpeta del módulo",
				new Throwable("Archivo de configuraciones no encontrado"));
	}
}
